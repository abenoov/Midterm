package kz.iitu.mukhtar.electricity.exceptions.handler;

import kz.iitu.mukhtar.electricity.exceptions.NoRoleException;
import kz.iitu.mukhtar.electricity.exceptions.BillNotFoundException;
import kz.iitu.mukhtar.electricity.exceptions.UserNotFoundException;
import kz.iitu.mukhtar.electricity.exceptions.model.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleUserNotFoundException(BillNotFoundException e) {
        log.error("Exception handled: " + e.getMessage(), e);
        ErrorResponse errorResponse = new ErrorResponse("404", e.getMessage());
